                ...
                <div class="h-16 flex items-center justify-between">
                    ...
                    <div class="relative group">
                        <a href="{{ route('admin.profile') }}">
                            <img src="{{ asset('images/profile.png') }}" class="h-8 w-8 rounded-full ring-2 ring-white cursor-pointer">
                        </a>
        ...
        <main class="mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-8 py-6">
            <div class="grid grid-cols-1 md:grid-cols-[220px_1fr] gap-6">
                ...
                <section class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                    ...
                    <form action="{{ route('admin.products.update', $product) }}" method="POST" enctype="multipart/form-data" class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        @csrf
                        @method('PUT')
                        ...
                        <div>
                            ...
                            <input type="number" step="1" name="discount" min="0" max="100"
                        ...
                        <div>
                            ...
                            <select name="category" required class="w-full h-10 px-3 rounded-lg border border-gray-200 text-sm">
                                ...
                                <option value="cosmetics" {{ old('category',$product->category)==='cosmetics'?'selected':'' }}>Cosmetics</option>
                            </select>
                        </div>
                        ...
                        <div>
                            ...
                            <select name="status" required class="w-full h-10 px-3 rounded-lg border border-gray-200 text-sm">
                        ...
                        <div>
                            ...
                            <select name="rating" required class="w-full h-10 px-3 rounded-lg border border-gray-200 text-sm">
                                @for ($i=0; $i<=5; $i++)
                        ...
                        <div>
                            ...
                            @if ($product->image_path)
                                <img src="{{ asset('storage/'.$product->image_path) }}" class="mt-2 h-16 w-16 rounded-lg object-cover">
                            @endif
                        </div>
                        ...
                        <div>
                            ...
                            @if ($product->image_path2)
                                <img src="{{ asset('storage/'.$product->image_path2) }}" class="mt-2 h-16 w-16 rounded-lg object-cover">
                            @endif
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="description" rows="4"
                                      class="w-full px-3 py-2 rounded-lg border border-gray-200 focus:ring-2 focus:ring-rose-500 text-sm">{{ old('description', $product->description) }}</textarea>
                        </div>

                        <!-- Buttons -->
                        <div class="md:col-span-2 flex flex-col sm:flex-row items-start sm:items-center gap-3">
                            <button class="px-5 py-2 bg-rose-600 text-white rounded-lg hover:bg-rose-700">Update</button>
