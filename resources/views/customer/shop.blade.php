    ...
    <div class="min-h-screen bg-neutral-50">
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-12 py-10 grid grid-cols-1 md:grid-cols-[250px_1fr] gap-8">
            ...
            <aside class="hidden md:block bg-white rounded-xl shadow-sm border border-gray-100 p-5 h-fit sticky top-24">
                ...
                <form method="GET" action="{{ route('shop.index') }}" class="flex flex-col gap-5">
                    {{-- Category --}}
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Category</label>
                        <select name="category" class="w-full h-10 px-3 border rounded-lg text-sm">
            ...
            <section>
                ...
                <div class="flex items-center justify-between mb-6">
                    <h2 class="text-lg font-semibold text-gray-800">{{ $products->total() }} Products</h2>
                </div>
